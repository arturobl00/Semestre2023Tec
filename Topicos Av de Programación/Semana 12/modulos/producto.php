...
<body class="container">
    <div class="container text-center mt-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <a href="./acciones/addproducto.php"><img alt="" src="../assets/nuevoproducto.png" width="100"/></a>
                <p>Nuevo Producto</p>
            </div>
            <div class="col">
                <a href="#"><img alt="" src="../assets/cargamasiva.png" width="100"/></a>
                <p>Carga Masiva</p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col">
                <a href="#"><img alt="" src="../assets/codigobarras.png" width="100"/></a>
